...
if st.session_state.analysis_started:
    try:
        ...
        if len(returns_array) == 0 or len(volatility_array) == 0:
            ...
            # Extract efficient frontier envelope (smooth top edge)
            ...
            # Extract efficient frontier: running maximum return
            efficient_vols = []
            efficient_rets = []
            ...
            # Plot smooth efficient frontier envelope
            fig.add_trace(go.Scatter(
                x=efficient_vols,
                y=efficient_rets,
                mode='lines',
                name='Efficient Frontier Edge',
                line=dict(color='darkblue', width=3, shape='spline', smoothing=1.3),
